...
namespace Saturn.Assembly
{
    public class Instruction : IAssembly
    {
        ...
        private uint Formalize(CodeFormat codeFormat, uint _base = 0x00)
        {
            ...
            {
                CodeFormat.One => (byte)Operand1 + _base,
                CodeFormat.Two => (byte)Operand2 + _base,
                CodeFormat.OneTwo => (byte)Operand1 * 0x08U + (byte)Operand2 + _base,
                CodeFormat.TwoOne => (byte)Operand2 * 0x08U + (byte)Operand1 + _base,
                CodeFormat.JustOne => (byte)Operand1 * 0x08U + _base,
                CodeFormat.JustTwo => (byte)Operand2 * 0x08U + _base,
                _ => 0,
            };
        }
        ...
        public override string ToString()
        {
            ...
            if (Operand1 != null)
            {
                builder.Append(
                    ...
                    "QWORD" + "[" + Operand1 + "]" :
                    Operand1 is PTRC ?
                    (Operand1 as PTRC).DataType.ToString() + "[" + (Operand1 as PTRC).BEString + "]" :
                    Operand1.ToString()
                    );
            }
            ...
            if (Operand2 != null)
            {
                ...
                builder.Append(
                    ...
                    "QWORD" + "[" + Operand2 + "]" :
                    Operand2 is PTRC ?
                    (Operand2 as PTRC).DataType.ToString() + "[" + (Operand2 as PTRC).BEString + "]" :
                    Operand2.ToString()
                    );
            }
